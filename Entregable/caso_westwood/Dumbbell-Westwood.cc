...
int main (int argc, char *argv[])
{
  ...
  std::string animFile = "SOR2-TP2-Dumbbell-Westwood-animation.xml" ;  
...
//Eseteamos TCP Westwood
  Config::SetDefault ("ns3::TcpL4Protocol::SocketType", StringValue ("ns3::TcpWestwood"));//TcpWestwood
  ...
  //Generacion de pcap's. - Captura de los paquetes de cada enlace (aristas).
    if (tracing)
    {
      p2pNode.EnablePcapAll ("SOR2-TP2-Dumbbell-Westwood", false);
